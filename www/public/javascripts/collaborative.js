...
var ping = function() {
	$.getJSON('/collaborate?lastUpdate=' + last_update + '&currentlyOnline=' + get_online_users(), function(response) {
		last_update = response.last_update
		
		// $(response.news).each(function(){
		// 	$.gritter.add({
		...
		str = '';
		$(response.online_users).each(function() {
		...
		$(response.updates).each(function() {
