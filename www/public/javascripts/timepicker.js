...
Timepicker.prototype = {
    ...
    update: function ()
    {
        var curTime = Number($('#' + this._mainDivId + ' span.fragHours').text()) * 60 * 60 + Number($('#' + this._mainDivId + ' span.fragMinutes').text()) * 60;

        var curDate = Number($('#' + this._inputId).val());

        $('#' + this._inputId).val(curDate + curTime*1000);
