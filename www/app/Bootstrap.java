...
public class Bootstrap extends Job
{
	public void doJob()
	{
		if( User.count() == 0 )
		{
			String[] perms = { "manageReviewerRequests", "addNote", "manageRoles", "createRole", "editRole", "deleteRole", "editProject", "editBacklog", "editProjectNotificationprofile", "editUserNotificationProfile", "addComponent", "editComponent", "deleteComponent", "addSprint", "editSprint", "editSprintBacklog", "addMeeting", "editMeeting", "deleteMeeting", "addStory", "editStory", "deleteStory", "changeEstimations", "changeTaskType", "changeTaskStatus", "changeTaskDescreption", "changeReviewer", "changeAssignee", "changeAssigneeInSprint", "invite", "manageRequests", "editColumn", "getComponentMembers", "chooseAssignee", "chooseReporter", "chooseReviewer", "addProductRole", "editProductRole", "deleteProductRole", "request", "setDependentStories", "editColumnsPositions", "assignStoryToSprint", "respond", "accept", "renameColumns", "addReviewLog", "AddTask", "modifyTask", "changeStatus", "addTaskStatus", "editTaskStatus", "addTaskType", "editTaskType", "viewReviewLog", "startGame", "viewChat", "associateTaskToMeeting", "reportImpediment", "editTask", "setMeetingAttendance", "deleteProject", "ShowColumn", "HideColumn", "AssociateArtifacts", "AssociateSprinttoMeeting", "joinMeeting", "revokeUserRole" };
			...
			a2.save();
			Meeting M = new Meeting( "OLD", users.get( 0 ), "anything", new Date().getTime() - 1000, new Date().getTime() - 60000, "C1", "meeting", p1, null );
			M.artifacts.add( a1 );
			M.artifacts.add( a2 );
			...
			Meeting m2 = new Meeting( "Current", users.get( 0 ), "15 minute scrum meeting", new Date().getTime() + 900000, new Date().getTime(), "board", "scrum", projects.get( 0 ), Sp1 );
			m2.components.add( c1 );

			c1.componentMeetings.add( m2 );
			m2.save();

			Meeting m3 = new Meeting( "upcoming", users.get( 0 ), "15 minute scrum meeting", new Date().getTime() + 1500000, new Date().getTime() + 900000, "board", "scrum", projects.get( 0 ), Sp1 );
