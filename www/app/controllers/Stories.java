...
// */
// @Check ("canAddStory")
// public static void addStory(String des, String succ, String fail, int
// priority, String notes) {
// String message = "";
// if (des.length() < 5) {
...
// */
// @Check ("canEditStory")
// public static void editStory(long id, String des, String succ, String fail,
// int priority, String notes) {
// String message = "";
...
// */
// @Check ("canRequest")
// public static void sendRequest(long id, String des, String succ, String fail,
// int priority, String notes) {
// // Get the priority
// String prio = "";
// switch (priority) {
...
// message += "The user " + myuser +
// " requested a change to a user story and here are the details :<br>";
...
// Mail.send(sender, projectOwnerEmail, "Editing a User Story Request",
// message);
