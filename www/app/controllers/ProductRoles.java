...
{
	/**
	 * Renders a list of the product roles that exists in a certain project,
	 *  the considered project id and it's name to the project's product roles view.
	 * 
	 * @author Heba Elsherif
	 * @parm id
	 *         the id of the considered project.
	 * @return void
	 * @task C3 S1 & S2 & S3
	 * @sprint 2
	 **/
	...
	/**
	 * Renders a product role and a boolean variable indicating if this product role 
	 * is included in a task that belongs to a current sprint to the product role view.
	 * 
	 * @author Heba Elsherif
	 * @parm id
	 *         the id of the considered project.
	...
	/**
	 * Overrides the CRUD blank method that renders the create form, 
	 * in order to take the project id to create a product role into it.
	 * @author Heba Elsherif
	 * @param id	
	...
	/**
	 * Overrides the CRUD create method that is invoked to submit the creation of the product role,
	 *  in order to associate the product role to the project and checks if it can be added with that data and adds it to the database.
	 * @author Heba Elsherif
	 * @param void
	 * @return void
	 * @task C3 S1
	 ...
	 * in order to take the project id and checks if it's editable.
	 * @author Heba Elsherif
	 * @param id	
	 *           the project id of the created product role.
	 * @return void
	...
	/**
	 * Overrides the CRUD save method that is invoked to submit the edit, 
	 * in order to check if the edits are acceptable.
	 * @author Heba Elsherif
	 * @param id	
	...
	public static void save(String id) throws Exception 
	{
        ...
        {
        	ProductRole oldProductRole = ProductRole.findById(productRoleObject.id);
        	String name = oldProductRole.name;
        	String header = "Product Role: " + name + " in Project " + project.name + " has been edited.";
	...
	/**
	 * Overrides the CRUD delete method that is invoked to delete a product role, 
	 * in order to delete the product role by setting the deleted boolean variable to true instade of deleting it.
	 * @author Heba Elsherif
	 * @param id	
	 ...
	 * @author Heba Elsherif
	 * @parm id
	 *           the id of the considered product role.
	 * @return void
	 * @task C3 S3
	 * @sprint 2
	 **/
