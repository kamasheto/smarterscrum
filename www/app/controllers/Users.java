...
public class Users extends SmartCRUD {
	...
	public static void manageNotificationProfile(long id) throws ClassNotFoundException {
		...
		Security.check(currentProject, "editUserNotificationProfile");
	 ...
	 * Sprint : 4
	 */
	public static void findUsers(long projectId, long componentId, int all){
		if(all == 1){
			render(User.findAll());
		}else{
			if(componentId !=0){
				Component component = Component.findById(componentId);
				render(component.componentUsers);
			}else{
