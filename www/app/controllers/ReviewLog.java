...
// String url =
// "@{Application.externalOpen("+m.project.id+", '/meetings/note?id="+note.id+"&noteFlag=true&i=0', false)}";
// Notifications.notifyUsers(getAttendanceConfirmed(m.id), "Edit", url,
// "Note in ", m.name, (byte) 0, m.project);
// }
