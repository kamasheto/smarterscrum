...
/**
 * This class represents the UserNotificationProfile Entity in the Database and it's 
...
public class UserNotificationProfile extends Model
{
	...
	/**
	 * This constructor creates a new UserNotificationProfile for a specific user
	 * "user" in a specific project "project" with the default notification options
	 *  as set in the ProjectNotificationProfile of that project.
	 *  @author Amr Tj.Wallas
	 *  @param user
	 *  @param project
	 *  @see models.ProjectNotificationProfile
	...
	/**
	 * @author Moataz_Mekki
	 * this helper method takes the action & returns the boolean variable of
	 * this action whether it's true or false 
	 * @param action:
	 * 				the string that describes the action
	 * @return:
	 * 			returns the boolean variable related to the action
	 */
