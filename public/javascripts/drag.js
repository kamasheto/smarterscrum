...
oldPos=cell_source-1;table_old=row_old=cell_old=null;if(row_source==row&&cell_source!=cell){$.post('/Tasks/changeTaskStatusHelper',{id:gup('sprintID'),columnSequence:cell-1,taskString:obj.id,user_id:selectedUser,cid:gup('componentID')});}
else if(row_source!=row&&gup('componentID')==0)
