 ...
 */
public class C3S36editTasktype extends UnitTest
{
	@Before
	public void setUp()
	{
	...
	public void createComponent()
	{
		...
		story1.save();
		String oldDesc=task1.taskType.name;
		TaskType type=new TaskType();
		type.name="new one";
		type.save();
		
		boolean z=Tasks.editTaskType(task1.id, type.id,assignee.id);
		assertTrue(task1.taskType.name.equals("new one"));
