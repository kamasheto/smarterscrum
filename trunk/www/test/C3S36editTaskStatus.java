 ...
 */
public class C3S36editTaskStatus extends UnitTest
{
	@Before
	public void setUp()
	{
	...
	public void createComponent()
	{
		...
		newstatus.name="new one";
		newstatus.save();
		
		boolean z=Tasks.editTaskStatus(task1.id,assignee.id,newstatus);
		assertTrue(task1.taskStatus.name.equals("new one"));
