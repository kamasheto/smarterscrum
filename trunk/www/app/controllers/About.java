...
public class About extends SmartController {
	public static void index() {
		String[] data = {
				"Amr Hany (C2), the CRUD guru!<br />Amr, the man behind the chat system, is akbar men keda bekter", // Amr
				// Hany
				...
				"Menna Ghoneim (C4-lead)<br /> You'll never find the AC off when she's around!!", // 
