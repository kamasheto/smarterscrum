...
// story.deleted = true;
// story.save();
// Logs.addLog(story.addedBy, "Delete", "Story", story.id, project, new
// Date(System.currentTimeMillis()));
// Notifications.notifyUsers(story.componentID.getUsers(), header, body, (byte)
// -1);
// } catch (Exception e) {
...
// try {
// render(request.controller.replace(".", "/") + "/blank.html", type, stories,
// project);
// } catch (TemplateNotFoundException e) {
// render("CRUD/blank.html", type);
// }
...
// if
// (storyObj.componentID.project.productRoles.get(j).name.equalsIgnoreCase(productrole))
// flag = true;
// }
// if (!flag) {
// ProductRole pr = new ProductRole(storyObj.componentID.project.id,
// productrole, "");
// pr.save();
...
// object.save();
// toBeSaved.init();
// Logs.addLog(toBeSaved.addedBy, "Create", "Story", storyObj.id, project, new
// Date(System.currentTimeMillis()));
...
// * toBeSaved.addedBy.name + ".";
// */
// Notifications.notifyUsers(storyObj.componentID.getUsers(), header, body,
// (byte) 1);
...
// */
// Logs.addLog(storyObj.addedBy, "Edit", "Story", storyObj.id, project, new
// Date(System.currentTimeMillis()));
// Notifications.notifyUsers(storyObj.componentID.getUsers(), header, body,
// (byte) 0);
...
// Story s = Story.findById(id);
// Security.check(Security.getConnected().in(s.componentID.project).can("editStory")
// && s.componentID.project == c.project);
// s.componentID = c;
// s.save();
// }
//
...
// **/
//
// public static void addRemoveDependentStories(long storyId, Story
// toBeAddedOrRemoved, boolean remove) {
...
// **/
//
// public static boolean editDependentStories(long storyId, ArrayList<Story>
// newList) {
// Story s = Story.findById(storyId);
...
// User user = Security.getConnected();
// Security.check(user.in(story.componentID.project).can("assignStoryToSprint")
// && user.in(sprint.project).can("assignStoryToSprint"));
//
// if (story == null) {
...
//
// }
// String header = "Story 'S" + story.id + "\'" +
// " has been assigned to Sprint: " + "\'" + sprint.sprintNumber + "\'" + ".";
...
// */
// Notifications.notifyProjectUsers(sprint.project, header, body,
// "assignStoryToSprint", (byte) 0);
// Logs.addLog(Security.getConnected(), "Assign", "Story To Sprint", story.id,
// sprint.project, new Date(System.currentTimeMillis()));
// story.save();
// sprint.save();
// renderText(message);
// }
...
// render(story1, successflag, failureflag, succsses, failure, succssesNum,
// failureNum, storyId, projectId);
//
// }
//
// /**
...
// story1.save();
// Logs.addLog(Security.getConnected(), "Create", "Succuss Senario", story1.id,
// story1.componentID.project, new Date(System.currentTimeMillis()));
// String header = "A new Succuss Senario has been added to Story 'S" +
// story1.id + "\'" + ".";
...
// * " Added by: " + "\'" + Security.getConnected().name + "\'" + ".";
// */
// Notifications.notifyUsers(story1.componentID.getUsers(), header, body, (byte)
// 0);
// }
//
// /**
...
// story1.save();
// Logs.addLog(Security.getConnected(), "Create", "Failure Senario", story1.id,
// story1.componentID.project, new Date(System.currentTimeMillis()));
// String header = "A new Failure Senario has been added to Story 'S" +
// story1.id + "\'" + ".";
// String body = "In Project: " + "\'" + story1.componentID.project.name + "\'"
// + "." + '\n' + " In Component: " + "\'" + story1.componentID.name + "\'" +
// "." + '\n' + " Added by: " + "\'" + Security.getConnected().name + "\'" +
...
// ok = false;
// message +=
// "<li>No components in this project and therefore, hopefully, no stories</li>";
// } else {
// // Check that there is at least one story in the project
// for (Component component : project.components) {
// if (component.componentStories == null ||
// component.componentStories.isEmpty())
// continue;
// else {
// noStories = false;
// break;
...
// */
//
// public static void magicShow(long projectId, long componentId, int reviewer,
// int assignee, long taskId, int tasks, long meetingId) {
// String title;
// if (componentId != 0) {
...
// if (inSprint) {
// message +=
// "The story can not be edited or deleted because it's in a sprint.";
// }
//
