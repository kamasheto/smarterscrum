...
public class Security extends Secure.Security {
	...
	// * given project. To access the current project, one must use the "id"
	// param
	...
	// * the projectId.
	// * <p>
	// * Example, editComponent refers to "Editing a component", hence "id"
	// should
	...
	// * @return true if user has permission to perform this action in the
	// current
	...
	// } else if (profile.equals("CanSetStatusToClosed") ||
	// profile.equals("CanSetStatusToVerified") ||
	// profile.equals("CanSetStatusToReopened")) {
